...
export class FontMetrics {
  ...
  measureTop(text) {
    return (
      Math.round(this.getFirstIndex(this.getPixels(text)) / this.canvas.width) -
      this.padding
    );
  }
  ...
  measureBottom(text) {
    return (
      Math.round(this.getLastIndex(this.getPixels(text)) / this.canvas.width) -
      this.padding
    );
  }
}
