...
c = ClassicColors;
ClassicColors.Border = rgba(0.5, 0.5, 0.5, 0.5);
ClassicColors.BorderShadow = rgba(0.0, 0.0, 0.0, 0.0);
ClassicColors.Button = rgba(0.35, 0.4, 0.61, 0.62);
ClassicColors.ButtonActive = rgba(0.46, 0.54, 0.8, 1.0);
ClassicColors.ButtonHovered = rgba(0.4, 0.48, 0.71, 0.79);
ClassicColors.CheckMark = rgba(0.9, 0.9, 0.9, 0.5);
ClassicColors.CheckerOff = rgbi(64, 64, 64);
ClassicColors.CheckerOn = rgbi(204, 204, 204);
ClassicColors.ChildBg = rgba(0.0, 0.0, 0.0, 0.0);
ClassicColors.DragDropTarget = rgba(1.0, 1.0, 0.0, 0.9);
ClassicColors.FBDir = rgb(0.2, 0.9, 0.2);
ClassicColors.FBFile = rgb(0.8, 0.8, 0.8);
ClassicColors.FBMkDir = rgb(0.2, 0.4, 0.9);
ClassicColors.FrameBg = rgba(0.43, 0.43, 0.43, 0.39);
ClassicColors.FrameBgActive = rgba(0.42, 0.41, 0.64, 0.69);
ClassicColors.FrameBgHovered = rgba(0.47, 0.47, 0.69, 0.4);
ClassicColors.Header = rgba(0.4, 0.4, 0.9, 0.45);
ClassicColors.HeaderActive = rgba(0.53, 0.53, 0.87, 0.8);
ClassicColors.HeaderHovered = rgba(0.45, 0.45, 0.9, 0.8);
ClassicColors.MenuBarBg = rgba(0.4, 0.4, 0.55, 0.8);
ClassicColors.ModalWindowDimBg = rgba(0.2, 0.2, 0.2, 0.35);
ClassicColors.NavHighlight = c.HeaderHovered;
ClassicColors.NavWindowingDimBg = rgba(0.8, 0.8, 0.8, 0.2);
ClassicColors.NavWindowingHighlight = rgba(1.0, 1.0, 1.0, 0.7);
ClassicColors.PlotBg = rgb(0.1, 0.1, 0.1);
ClassicColors.PlotHistogram = rgba(0.9, 0.7, 0.0, 1.0);
ClassicColors.PlotHistogramDimmed = rgba(1.0, 0.6, 0.0, 1.0);
ClassicColors.PlotHistogramHovered = rgba(1.0, 0.6, 0.0, 1.0);
ClassicColors.PlotLines = rgba(1.0, 1.0, 1.0, 1.0);
ClassicColors.PlotLinesDimmed = rgba(0.9, 0.7, 0.0, 1.0);
ClassicColors.PlotLinesHovered = rgba(0.9, 0.7, 0.0, 1.0);
ClassicColors.PlotSignal = rgba(1.0, 1.0, 1.0, 1.0);
ClassicColors.PlotSignalDimmed = rgba(0.9, 0.7, 0.0, 1.0);
ClassicColors.PlotSignalHovered = rgba(0.9, 0.7, 0.0, 1.0);
ClassicColors.PopupBg = rgba(0.11, 0.11, 0.14, 0.92);
ClassicColors.ResizeGrip = rgba(1.0, 1.0, 1.0, 0.16);
ClassicColors.ResizeGripActive = rgba(0.78, 0.82, 1.0, 0.9);
ClassicColors.ResizeGripHovered = rgba(0.78, 0.82, 1.0, 0.6);
ClassicColors.ScrollbarBg = rgba(0.2, 0.25, 0.3, 0.6);
ClassicColors.ScrollbarGrab = rgba(0.4, 0.4, 0.8, 0.3);
ClassicColors.ScrollbarGrabActive = rgba(0.41, 0.39, 0.8, 0.6);
ClassicColors.ScrollbarGrabHovered = rgba(0.4, 0.4, 0.8, 0.4);
ClassicColors.Separator = rgba(0.5, 0.5, 0.5, 1.0);
ClassicColors.SeparatorActive = rgba(0.7, 0.7, 0.9, 1.0);
ClassicColors.SeparatorHovered = rgba(0.6, 0.6, 0.7, 1.0);
ClassicColors.SliderGrab = rgba(1.0, 1.0, 1.0, 0.3);
ClassicColors.SliderGrabActive = rgba(0.41, 0.39, 0.8, 0.6);
ClassicColors.Tab = Color.Lerp(c.Header, c.TitleBgActive, 0.8);
ClassicColors.TabActive = Color.Lerp(c.HeaderActive, c.TitleBgActive, 0.6);
ClassicColors.TabHovered = c.HeaderHovered;
ClassicColors.TabUnfocused = Color.Lerp(c.Tab, c.TitleBg, 0.8);
ClassicColors.TabUnfocusedActive = Color.Lerp(c.TabActive, c.TitleBg, 0.4);
ClassicColors.Text = rgba(0.9, 0.9, 0.9, 1.0);
ClassicColors.TextDisabled = rgba(0.6, 0.6, 0.6, 1.0);
ClassicColors.TextEmphasized = rgba(0.6, 0.8, 0.6, 1.0);
ClassicColors.TextError = CSSColors.darkorange;
ClassicColors.TextSelectedBg = rgba(0.0, 0.0, 1.0, 0.35);
ClassicColors.TitleBg = rgba(0.27, 0.27, 0.54, 0.83);
ClassicColors.TitleBgActive = rgba(0.32, 0.32, 0.63, 0.87);
ClassicColors.TitleBgCollapsed = rgba(0.4, 0.4, 0.8, 0.2);
ClassicColors.WindowBg = rgba(0.0, 0.0, 0.0, 0.7);

export var LightColors = Object.assign({}, DarkColors); // inherit
c = LightColors;
LightColors.Border = rgba(0.0, 0.0, 0.0, 0.3);
LightColors.BorderShadow = rgba(0.0, 0.0, 0.0, 0.0);
LightColors.Button = rgba(0.26, 0.59, 0.98, 0.4);
LightColors.ButtonActive = rgba(0.06, 0.53, 0.98, 1.0);
LightColors.ButtonHovered = rgba(0.26, 0.59, 0.98, 1.0);
LightColors.CheckMark = rgba(0.26, 0.59, 0.98, 1.0);
LightColors.CheckerOff = rgbi(64, 64, 64);
LightColors.CheckerOn = rgbi(204, 204, 204);
LightColors.ChildBg = rgba(0.0, 0.0, 0.0, 0.0);
LightColors.DragDropTarget = rgba(0.26, 0.59, 0.98, 0.95);
LightColors.FBDir = rgb(0.2, 0.9, 0.2);
LightColors.FBFile = rgb(0.8, 0.8, 0.8);
LightColors.FBMkDir = rgb(0.2, 0.4, 0.9);
LightColors.FrameBg = rgba(1.0, 1.0, 1.0, 1.0);
LightColors.FrameBgActive = rgba(0.26, 0.59, 0.98, 0.67);
LightColors.FrameBgHovered = rgba(0.26, 0.59, 0.98, 0.4);
LightColors.Header = rgba(0.26, 0.59, 0.98, 0.31);
LightColors.HeaderActive = rgba(0.26, 0.59, 0.98, 1.0);
LightColors.HeaderHovered = rgba(0.26, 0.59, 0.98, 0.8);
LightColors.MenuBarBg = rgba(0.86, 0.86, 0.86, 1.0);
LightColors.ModalWindowDimBg = rgba(0.2, 0.2, 0.2, 0.35);
LightColors.NavHighlight = c.HeaderHovered;
LightColors.NavWindowingDimBg = rgba(0.2, 0.2, 0.2, 0.2);
LightColors.NavWindowingHighlight = rgba(0.7, 0.7, 0.7, 0.7);
LightColors.PlotBg = rgb(0.1, 0.1, 0.1);
LightColors.PlotHistogram = rgba(0.9, 0.7, 0.0, 1.0);
LightColors.PlotHistogramDimmed = rgba(0.9, 0.7, 0.0, 1.0);
LightColors.PlotHistogramHovered = rgba(1.0, 0.45, 0.0, 1.0);
LightColors.PlotLines = rgba(0.39, 0.39, 0.39, 1.0);
LightColors.PlotLinesDimmed = rgba(0.39, 0.39, 0.39, 1.0);
LightColors.PlotLinesHovered = rgba(1.0, 0.43, 0.35, 1.0);
LightColors.PlotSignal = rgba(0.9, 0.7, 0.0, 1.0);
LightColors.PlotSignalDimmed = rgba(0.9, 0.7, 0.0, 1.0);
LightColors.PlotSignalHovered = rgba(1.0, 0.45, 0.0, 1.0);
LightColors.PopupBg = rgba(1.0, 1.0, 1.0, 0.98);
LightColors.ResizeGrip = rgba(0.8, 0.8, 0.8, 0.56);
...
LightColors.ScrollbarGrab = rgba(0.69, 0.69, 0.69, 0.8);
LightColors.ScrollbarGrabActive = rgba(0.49, 0.49, 0.49, 1.0);
LightColors.ScrollbarGrabHovered = rgba(0.49, 0.49, 0.49, 0.8);
LightColors.Separator = rgba(0.39, 0.39, 0.39, 1.0);
LightColors.SeparatorActive = rgba(0.14, 0.44, 0.8, 1.0);
LightColors.SeparatorHovered = rgba(0.14, 0.44, 0.8, 0.78);
LightColors.SliderGrab = rgba(0.26, 0.59, 0.98, 0.78);
LightColors.SliderGrabActive = rgba(0.46, 0.54, 0.8, 0.6);
LightColors.Tab = Color.Lerp(c.Header, c.TitleBgActive, 0.9);
LightColors.TabActive = Color.Lerp(c.HeaderActive, c.TitleBgActive, 0.6);
LightColors.TabHovered = c.HeaderHovered;
LightColors.TabUnfocused = Color.Lerp(c.Tab, c.TitleBg, 0.8);
LightColors.TabUnfocusedActive = Color.Lerp(c.TabActive, c.TitleBg, 0.4);
LightColors.Text = rgba(0.0, 0.0, 0.0, 1.0);
LightColors.TextDisabled = rgba(0.6, 0.6, 0.6, 1.0);
LightColors.TextEmphasized = rgba(0.0, 0.2, 0.0, 1.0);
LightColors.TextError = CSSColors.darkorange;
LightColors.TextSelectedBg = rgba(0.26, 0.59, 0.98, 0.35);
LightColors.TitleBg = rgba(0.96, 0.96, 0.96, 1.0);
LightColors.TitleBgActive = rgba(0.82, 0.82, 0.82, 1.0);
LightColors.TitleBgCollapsed = rgba(1.0, 1.0, 1.0, 0.51);
...
export class Style extends SettingsHandler {
  ...
  Encapsulate(imgui) {
    ...
    for (let k of Object.getOwnPropertyNames(this)) {
      ...
      } else o[k] = this[k]; // ok for Vec2, see Instantiate
    }
  ...
  Clone() {
    ...
    s.Colors = {};
    for (let cnm in this.Colors) s.Colors[cnm] = this.Colors[cnm].Clone();
    return s;
  }
