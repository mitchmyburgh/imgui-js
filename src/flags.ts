...
export enum HoveredFlags {
  ...
  RectOnly = (1 << 3) | (1 << 5) | (1 << 6), //AllowWhenBlockedByPopup | HoveredFlags.AllowWhenBlockedByActiveItem | HoveredFlags.AllowWhenOverlapped;
  RootAndChildWindows = (1 << 1) | (1 << 0), //HoveredFlags.RootWindow | HoveredFlags.ChildWindows
}

export enum NavHighlightFlags {
  None = 0,
  TypeDefault = 1 << 0,
  TypeThin = 1 << 1,
...
export enum ColorEditFlags {
  ...
  OptionsDefault = (1 << 23) | (1 << 20) | (1 << 27) | (1 << 25), //ColorEditFlags.Uint8 | ColorEditFlags.DisplayRGB | ColorEditFlags.InputRGB | ColorEditFlags.PickerHueBar;
  DisplayMask = (1 << 20) | (1 << 21) | (1 << 22), // ColorEditFlags.DisplayRGB | ColorEditFlags.DisplayHSV | ColorEditFlags.DisplayHex;
  DataTypeMask = (1 << 23) | (1 << 24), // ColorEditFlags.Uint8 | ColorEditFlags.Float;
  PickerMask = (1 << 26) | (1 << 25), // ColorEditFlags.PickerHueWheel | ColorEditFlags.PickerHueBar;
  InputMask = (1 << 27) | (1 << 28), // ColorEditFlags.InputRGB | ColorEditFlags.InputHSV;
}

export enum NavDirSourceFlags {
  None = 0,
  Keyboard = 1 << 0,
  PadDPa = 1 << 1,
  PadLStic = 1 << 2,
...
// CornerFlags.All
export enum CornerFlags {
  TopLeft = 1 << 0, // 0x1
  TopRight = 1 << 1, // 0x2
  BotLeft = 1 << 2, // 0x4
  BotRight = 1 << 3, // 0x8
  Top = (1 << 0) | (1 << 1), // f.TopLeft | f.TopRight; // 0x3
  Bot = (1 << 2) | (1 << 3), // f.BotLeft | f.BotRight; // 0xC
  Left = (1 << 0) | (1 << 2), // f.TopLeft | f.BotLeft; // 0x5
  Right = (1 << 1) | (1 << 3), // f.TopRight | f.BotRight; // 0xA
  All = 0xf,
}

export enum DrawListFlags {
  None = 0,
